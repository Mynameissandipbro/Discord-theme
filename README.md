...
.defaultColor_a595eb:not(.lookFilled_dd4f85.colorWhite_dd4f85 .defaultColor_a595eb) {
    color: white;
}
...
.optionButton_bd5e1f.selected_bd5e1f {
    border: 2px solid black;
    background-color: rgba(0, 0, 0, .2);
}
